...
| `vercel.json` | Vercel Python serverless build ve route yapılandırması. |
| `api/vercel_app.py` | Vercel ASGI app entrypoint. |
| `scripts/deploy_vercel.sh` | Production Vercel build/deploy script'i. |
| `docs/vercel-deploy-tr.md` | Başlatmadan finale Vercel yayın rehberi. |
